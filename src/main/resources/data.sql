...
--USERS
INSERT INTO users(insert_date_time, insert_user_id,  last_update_date_time, last_update_user_id,first_name,last_name,user_name,email,birth_date,phone_number,gender,enabled,role_id,password)
VALUES ('2021-01-01 00:00:00',1,'2021-01-01 01:00:00',1,
'admin','admin','admin','admin@projectmanagement.com','2000-01-01','1234567890','MALE',true,1,'$2a$10$rwR2GkGu5q3sOv3xPJJVYeUF91P.ZjcDUrgnM1kvLq7KBpB2NdsPm');
INSERT INTO users(insert_date_time, insert_user_id,  last_update_date_time, last_update_user_id,first_name,last_name,user_name,email,birth_date,phone_number,gender,enabled,role_id,password)
VALUES ('2021-01-01 00:00:00',1,'2021-01-01 02:00:00',1,
'Paola','Bonelli','pbonelli','p.bonelli@projectmanagement.com','1980-03-27','3126789201','FEMALE',true,2,'$2a$10$rwR2GkGu5q3sOv3xPJJVYeUF91P.ZjcDUrgnM1kvLq7KBpB2NdsPm');
INSERT INTO users(insert_date_time, insert_user_id,  last_update_date_time, last_update_user_id,first_name,last_name,user_name,email,birth_date,phone_number,gender,enabled,role_id,password)
VALUES ('2021-01-01 00:00:00',1,'2021-01-01 03:00:00',1,
'Selma','Gruber','sgruber','s.gruber@projectmanagement.com','1983-11-02','2134423121','FEMALE',true,2,'$2a$10$rwR2GkGu5q3sOv3xPJJVYeUF91P.ZjcDUrgnM1kvLq7KBpB2NdsPm');
INSERT INTO users(insert_date_time, insert_user_id,  last_update_date_time, last_update_user_id,first_name,last_name,user_name,email,birth_date,phone_number,gender,enabled,role_id,password)
VALUES ('2021-01-01 00:00:00',1,'2021-01-01 04:00:00',1,
'Vlad','Popesco','vpopesco','v.popesco@projectmanagement.com','1988-01-23','5213110230','MALE',true,1,'$2a$10$rwR2GkGu5q3sOv3xPJJVYeUF91P.ZjcDUrgnM1kvLq7KBpB2NdsPm');
INSERT INTO users(insert_date_time, insert_user_id,  last_update_date_time, last_update_user_id,first_name,last_name,user_name,email,birth_date,phone_number,gender,enabled,role_id,password)
VALUES ('2021-01-01 00:00:00',1,'2021-01-01 05:00:00',1,
'Adrian','Noel','anoel','a.noel@projectmanagement.com','1990-05-20','7445698213','MALE',true,1,'$2a$10$rwR2GkGu5q3sOv3xPJJVYeUF91P.ZjcDUrgnM1kvLq7KBpB2NdsPm');
INSERT INTO users(insert_date_time, insert_user_id,  last_update_date_time, last_update_user_id,first_name,last_name,user_name,email,birth_date,phone_number,gender,enabled,role_id,password)
VALUES ('2021-01-01 00:00:00',1,'2021-01-01 06:00:00',1,
'Diego','Pizarro','dpizarro','d.pizarro@projectmanagement.com','2000-01-01','8975541233','MALE',true,2,'$2a$10$rwR2GkGu5q3sOv3xPJJVYeUF91P.ZjcDUrgnM1kvLq7KBpB2NdsPm');
INSERT INTO users(insert_date_time, insert_user_id,  last_update_date_time, last_update_user_id,first_name,last_name,user_name,email,birth_date,phone_number,gender,enabled,role_id,password)
VALUES ('2021-01-01 00:00:00',1,'2021-01-01 07:00:00',1,
'Said','Aly','saly','s.aly@projectmanagement.com','1977-05-04','2415678892','MALE',true,3,'$2a$10$rwR2GkGu5q3sOv3xPJJVYeUF91P.ZjcDUrgnM1kvLq7KBpB2NdsPm');
INSERT INTO users(insert_date_time, insert_user_id,  last_update_date_time, last_update_user_id,first_name,last_name,user_name,email,birth_date,phone_number,gender,enabled,role_id,password)
VALUES ('2021-01-01 00:00:00',1,'2021-01-01 08:00:00',1,
'Madalina','Maglione','mmaglione','m.maglione@projectmanagement.com','1983-08-12','2341577890','FEMALE',true,3,'$2a$10$rwR2GkGu5q3sOv3xPJJVYeUF91P.ZjcDUrgnM1kvLq7KBpB2NdsPm');
INSERT INTO users(insert_date_time, insert_user_id,  last_update_date_time, last_update_user_id,first_name,last_name,user_name,email,birth_date,phone_number,gender,enabled,role_id,password)
VALUES ('2021-01-01 00:00:00',1,'2021-01-01 09:00:00',1,
'Sebastian','Brown','sbrown','s.brown@projectmanagement.com','1978-09-25','2567801234','MALE',true,3,'$2a$10$rwR2GkGu5q3sOv3xPJJVYeUF91P.ZjcDUrgnM1kvLq7KBpB2NdsPm');
INSERT INTO users(insert_date_time, insert_user_id,  last_update_date_time, last_update_user_id,first_name,last_name,user_name,email,birth_date,phone_number,gender,enabled,role_id,password)
VALUES ('2021-01-01 00:00:00',1,'2021-01-01 10:00:00',1,
'Claudia','Schultz','cschultz','c.schultz@projectmanagement.com','1983-12-29','4545678912','FEMALE',true,3,'$2a$10$rwR2GkGu5q3sOv3xPJJVYeUF91P.ZjcDUrgnM1kvLq7KBpB2NdsPm');
--PROJECTS
...
INSERT INTO tasks(insert_date_time, insert_user_id, last_update_date_time, last_update_user_id, task_subject,task_code, task_detail, task_status, assigned_date, user_id, project_id)
VALUES ('2021-01-01 00:00:00',1,'2021-01-01 05:00:00',1,
'Configuration setup','RPG-2','Setting up the additional configurations for Random Password Generator','OPEN','2021-01-03',10,1);